        ...
        <>
            ...
            <SafeAreaView style={styles.container}>
                <View style={styles.header}>
                    ...
                    <Text style={styles.headerSubtitle}>Manage your daily routines</Text>
                </View>
                    ...
                    <View style={styles.section}>
                        ...
                        <View style={styles.habitCard}>
                            <View style={styles.habitInfo}>
                                ...
                                <Text style={styles.habitDescription}>30 minutes of workout every morning</Text>
                        ...
                        <View style={styles.habitCard}>
                            <View style={styles.habitInfo}>
                                ...
                                <Text style={styles.habitDescription}>Read for at least 30 minutes</Text>
                        ...
                        <View style={styles.habitCard}>
                            <View style={styles.habitInfo}>
                                ...
                                <Text style={styles.habitDescription}>8 glasses of water daily</Text>
